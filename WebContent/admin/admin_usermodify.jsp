...
<%@ include file="menu.jsp" %>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/MonkShop/admin/admin_index.jsp/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="admin_user.jsp">用户管理</a><span class="crumb-step">&gt;</span><span>新增用户</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/MonkShop/admin/admin_douserupdate" method="post" id="myform" name="myform">
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" readonly="readonly" id="title" name="userName" size="50" value="${user.USER_ID }" type="text">
                                </td>
                            </tr>
