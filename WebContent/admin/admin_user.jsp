    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="/MonkShop/admin/admin_douserselect" method="get">
        ...
        <div id="register" class="result-wrap">
            <form action="/MonkShop/admin/admin_douserdel" id="myform" method="post">
	                        ...
	                        <tr>
	                            ...
	                            <td>
	                              ...
	                              <c:if test="${u.USER_STATUS ==1 }">
	                                <a class="link-del" href="javascript:Delete('你确定要删除用户【${u.USER_NAME} }】吗？', '/MonkShop/admin/admin_douserdel?id=${u.USER_ID}&cpage=${cpage }')">删除</a>
	                              </c:if>
