...
<div class="reg">
    <form action="register" method="post" onsubmit="return checkForm(this)"><h1><a href="index.html"><img src="img/temp/logo.png"></a></h1>
        ...
        <p>ID号<input type="text" name="userName" readonly="readonly" value="<%=(int)(Math.floor(Math.random()*100000000+1))%>" id="id"/><span></span></p>
        <p>昵称<input type="text" name="name" value="" onfocus="FocusItem(this)" onblur="CheckItem(this)" placeholder="请输入昵称"><span></span></p>
        <p>密码<input type="password" name="passWord" value="" onfocus="FocusItem(this)" onblur="CheckItem(this)" placeholder="请输入密码"><span></span></p>
         <p>重复密码<input type="password" name="rePassWord" value="" onfocus="FocusItem(this)" onblur="CheckItem(this)" placeholder="请输确认密码"><span></span></p>
        <p>
