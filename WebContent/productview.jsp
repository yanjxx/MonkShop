...
<head>
    <meta charset="UTF-8">
    <title>${p.PRODUCT_NAME }--详情页</title>
...
<div class="detCon">
    <div class="proDet wrapper">
        <div class="proCon clearfix">
            <div class="proImg fl">
            <img class="det" src="product/${p.PRODUCT_FILENAME }"/>
                <div class="smallImg clearfix"><img src="product/${p.PRODUCT_FILENAME }"
                                                    data-src="product/${p.PRODUCT_FILENAME }"><img
            ...
            <div class="fr intro">
                ...
                <div class="proIntro"><p>颜色分类</p>
                    <div class="smallImg clearfix categ"><p class="fl"><img src="product/${p.PRODUCT_FILENAME }"
                                                                            alt=""
                                                                            data-src="product/${p.PRODUCT_FILENAME }"></p>
...
<div class="introMsg wrapper clearfix">
    ...
    <div class="msgR fr" style="width:200px;"><h4>为你推荐</h4>
        ...
        <a href="selectproductview?id=${cp.PRODUCT_ID }">
            <dl>
                <dt><img src="product/${cp.PRODUCT_FILENAME }"></dt>
                ...
                <div>
                 ...
                 <c:forEach var="lp" items="${lastlylist }">
			        <a href="selectproductview?id=${lp.PRODUCT_ID }">
			            <dl>
			                <dt><img src="product/${lp.PRODUCT_FILENAME }"></dt>
